package resources.orariodelnegozio.xml.generatorxml;
 ...
 * @version 1.0
 * @file GeneratorXMLModificaOrarioDelNegozio.java
 *
 * @brief Classe generator per i file XML con struttura "OrarioDelNegozio"
 */
import java.io.File;
 ...
 * @author Barsotti Mirko bmirko1505@gmail.com
 * @author Brambilla Mirko brambobilla01@gmail.com
 * @class GeneratorXMLModificaOrarioDelNegozio
 *
 * @brief Classe generator per i file XML con struttura "OrarioDelNegozio"
 *
 ...
 * "OrarioDelNegozio"
 */
public class GeneratorXMLModificaOrarioDelNegozio {
     ...
     *
     * @see GeneratorXMLModificaOrarioDelNegozio.document
     */
    public GeneratorXMLModificaOrarioDelNegozio() {
     ...
     * @throws ParserConfigurationException
     *
     * @see GeneratorXMLModificaOrarioDelNegozio.createDocument()
     * @see GeneratorXMLModificaOrarioDelNegozio.document
     */
    public void createDOMTree(ArrayList<OrarioDelNegozio> data) throws ParserConfigurationException {
        ...
        rootTag = document.createElement("orarioDelNegozio");
     ...
     * @see GeneratorXMLModificaOrarioDelNegozio.document
     */
    private Element get(OrarioDelNegozio singleElement) {
        // L'elemento/tag XML risultato di questa operazione
        Element getOperationResult = document.createElement("orario");
        ...
        // l'unico parametro String specificato al metodo in questione.
        // Il tag XML ottenuto è di tipo Element (infatti un tag XML è un elemento XML)        
        supportiveTag = document.createElement("oraDiApertura");
        ...
        text = document.createTextNode(singleElement.getOraDiApertura());
        ...
        // l'unico parametro String specificato al metodo in questione.
        // Il tag XML ottenuto è di tipo Element (infatti un tag XML è un elemento XML)        
        supportiveTag = document.createElement("oraDiChiusura");

        // Attraverso l'uso del metodo createTextNode creo un elemento testuale che potrà
        // essere inserito all'interno di un preesistente tag/elemento XML.
        // Il testo è specificato dall'unico parametro String specificato al metodo in questione.
        text = document.createTextNode(singleElement.getOraDiChiusura());
