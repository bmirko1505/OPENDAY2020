package resources.orariodelnegozio.xml.parserxml;
 ...
 * @version 1.0
 * @file ParserXMLModificaOrarioDelNegozio.java
 *
 * @brief Classe parser per i file XML con struttura "OrarioDelNegozio"
 */
 ...
 * @author Barsotti Mirko bmirko1505@gmail.com
 * @author Brambilla Mirko brambobilla01@gmail.com
 * @class ParserXMLModificaOrarioDelNegozio
 *
 * @brief Classe parser per i file XML con struttura "OrarioDelNegozio"
 *
 ...
 * "OrarioDelNegozio"
 */
public class ParserXMLModificaOrarioDelNegozio {
     ...
     */
    private final ArrayList<OrarioDelNegozio> parsingResult;
     ...
     *
     * @see ParserXMLModificaOrarioDelNegozio.parsingResult
     */
    public ParserXMLModificaOrarioDelNegozio() {
     ...
     * @see ParserXMLModificaOrarioDelNegozio.parsingResult
     */
    public ArrayList<OrarioDelNegozio> parseDocument(String path) throws ParserConfigurationException, SAXException, IOException, ParseException {
        ...
        nodelist = rootTag.getElementsByTagName("orario");
...
// In questo caso, stiamo trattando TAG -> 'MyClass'
    ...
    private void put(Element singleTag) throws ParseException {
        ...
        String tagName1 = singleTag.getElementsByTagName("oraDiApertura").item(0).getTextContent();
        String tagName2 = singleTag.getElementsByTagName("oraDiChiusura").item(0).getTextContent();

        // Aggiunta al vettore dinamico
        // Usa la classe SimpleDateFormat per gestire le date (da String a Date)
        this.parsingResult.add(new OrarioDelNegozio(tagName1, tagName2));
    }
}
