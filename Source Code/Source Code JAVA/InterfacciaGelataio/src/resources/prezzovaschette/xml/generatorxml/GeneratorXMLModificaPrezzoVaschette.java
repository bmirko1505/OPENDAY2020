package resources.prezzovaschette.xml.generatorxml;
 ...
 * @version 1.0
 * @file GeneratorXMLModificaPrezzoVaschette.java
 *
 * @brief Classe generator per i file XML con struttura "PrezzoVaschette"
 */
import java.io.File;
 ...
 * @author Barsotti Mirko bmirko1505@gmail.com
 * @author Brambilla Mirko brambobilla01@gmail.com
 * @class GeneratorXMLModificaPrezzoVaschette
 *
 * @brief Classe generator per i file XML con struttura "PrezzoVaschette"
 *
 * La seguente classe fornisce un generatore di file XML con struttura
 * "PrezzoVaschette"
 */
public class GeneratorXMLModificaPrezzoVaschette {
     ...
     *
     * @see GeneratorXMLModificaPrezzoVaschette.document
     */
    public GeneratorXMLModificaPrezzoVaschette() {
     ...
     * @throws ParserConfigurationException
     *
     * @see GeneratorXMLModificaPrezzoVaschette.createDocument()
     * @see GeneratorXMLModificaPrezzoVaschette.document
     */
    public void createDOMTree(ArrayList<PrezzoVaschette> data) throws ParserConfigurationException {
        ...
        rootTag = document.createElement("prezzoVaschette");
     ...
     * @see GeneratorXMLModificaPrezzoVaschette.document
     */
    private Element get(PrezzoVaschette singleElement) {
        // L'elemento/tag XML risultato di questa operazione
        Element getOperationResult = document.createElement("prezzo");
        ...
        // l'unico parametro String specificato al metodo in questione.
        // Il tag XML ottenuto è di tipo Element (infatti un tag XML è un elemento XML)        
        supportiveTag = document.createElement("vaschettaPiccola");
        ...
        text = document.createTextNode(singleElement.getPrezzoVaschettaPiccola().toString());
        ...
        // l'unico parametro String specificato al metodo in questione.
        // Il tag XML ottenuto è di tipo Element (infatti un tag XML è un elemento XML)        
        supportiveTag = document.createElement("vaschettaMedia");

        // Attraverso l'uso del metodo createTextNode creo un elemento testuale che potrà
        // essere inserito all'interno di un preesistente tag/elemento XML.
        // Il testo è specificato dall'unico parametro String specificato al metodo in questione.
        text = document.createTextNode(singleElement.getPrezzoVaschettaMedia().toString());
        ...
        // l'unico parametro String specificato al metodo in questione.
        // Il tag XML ottenuto è di tipo Element (infatti un tag XML è un elemento XML)        
        supportiveTag = document.createElement("vaschettaGrande");

        // Attraverso l'uso del metodo createTextNode creo un elemento testuale che potrà
        // essere inserito all'interno di un preesistente tag/elemento XML.
        // Il testo è specificato dall'unico parametro String specificato al metodo in questione.
        text = document.createTextNode(singleElement.getPrezzoVaschettaGrande().toString());
