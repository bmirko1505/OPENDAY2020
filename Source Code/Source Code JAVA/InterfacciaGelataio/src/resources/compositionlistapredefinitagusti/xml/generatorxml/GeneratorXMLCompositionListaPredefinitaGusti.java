package resources.compositionlistapredefinitagusti.xml.generatorxml;
 ...
 * @version 1.0
 * @file GeneratorXMLCompositionListaPredefinitaGusti.java
 *
 * @brief Classe generator per i file XML con struttura
 ...
 * @author Barsotti Mirko bmirko1505@gmail.com
 * @author Brambilla Mirko brambobilla01@gmail.com
 * @class GeneratorXMLCompositionListaPredefinitaGusti
 *
 * @brief Classe generator per i file XML con struttura
 * "CompositionListaPredefinitaGusti"
 *
 ...
 * "CompositionListaPredefinitaGusti"
 */
public class GeneratorXMLCompositionListaPredefinitaGusti {
     ...
     *
     * @see GeneratorXMLCompositionListaPredefinitaGusti.document
     */
    public GeneratorXMLCompositionListaPredefinitaGusti() {
     ...
     * @throws ParserConfigurationException
     *
     * @see GeneratorXMLCompositionListaPredefinitaGusti.createDocument()
     * @see GeneratorXMLCompositionListaPredefinitaGusti.document
     */
    public void createDOMTree(ArrayList<CompositionListaPredefinitaGusti> data) throws ParserConfigurationException {
        ...
        rootTag = document.createElement("gusti");
     ...
     * @see GeneratorXMLCompositionListaPredefinitaGusti.document
     */
    private Element get(CompositionListaPredefinitaGusti singleElement) {
        // L'elemento/tag XML risultato di questa operazione
        Element getOperationResult = document.createElement("prodotto");
        ...
        supportiveTag = document.createElement("gusto");
        ...
        text = document.createTextNode(singleElement.getGusto());
        ...
        supportiveTag = document.createElement("tipo");

        text = document.createTextNode(singleElement.getTipo());

        supportiveTag.appendChild(text);
        getOperationResult.appendChild(supportiveTag);

        supportiveTag = document.createElement("prezzo");

        text = document.createTextNode(singleElement.getPrezzo().toString());
