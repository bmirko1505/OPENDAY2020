package resources.ordine.xml.generatorxmlv3;
...
public class GeneratorXMLOrdinev3 {
     ...
     *
     * @see GeneratorXMLOrdinev3.document
     */
    public GeneratorXMLOrdinev3() throws ParserConfigurationException, SAXException, IOException {
     ...
     *
     * @param path File dal quale estrarre la già esistente struttura XML alla
     * quale aggiungere (in append) nodi
     ...
     * @throws java.io.IOException
     *
     * @see GeneratorXMLOrdinev3.createDocument()
     * @see GeneratorXMLOrdinev3.document
     */
    public void createDOMTree(String path, ArrayList<Ordine> data) throws ParserConfigurationException, SAXException, IOException {
        if (path != null) {
            this.document = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(path);
        }
    ...
    private Element get(Ordine singleElement) {
        ...
        // essere inserito all'interno di un preesistente tag/elemento XML.
        // Il testo è specificato dall'unico parametro String specificato al metodo in questione.
        text = document.createTextNode(singleElement.getPrezzoTotale().toString());
